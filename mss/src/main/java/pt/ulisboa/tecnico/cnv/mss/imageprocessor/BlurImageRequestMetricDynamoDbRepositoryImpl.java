...
public class BlurImageRequestMetricDynamoDbRepositoryImpl implements ImageProcessorRequestMetricRepository {
    public static final String TABLE_NAME = "blur_image_requests";
    ...
    public BlurImageRequestMetricDynamoDbRepositoryImpl(DynamoDbClientManager dynamoDbClientManager) {
