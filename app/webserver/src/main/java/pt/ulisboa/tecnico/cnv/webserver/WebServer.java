...
import pt.ulisboa.tecnico.cnv.javassist.tools.RequestAnalyser;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Filter metricsRecorderFilter = Filter.afterHandler(
                ...
                httpExchange -> {
                    ...
                    Request request = RequestAnalyser.getThreadRequest(threadId);
                    if (request != null)
                        LOGGER.info(String.format("[%s] Request from thread %s: %s%n", RequestAnalyser.class.getSimpleName(), threadId, request));
                }
        );
