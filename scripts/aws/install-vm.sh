...
run_cmd="source /home/ec2-user/config.sh && java -cp /home/ec2-user/$webserver_jar -javaagent:/home/ec2-user/$instrumentation_jar=RequestAnalyzer:pt.ulisboa.tecnico.cnv.imageproc,pt.ulisboa.tecnico.cnv.raytracer:output pt.ulisboa.tecnico.cnv.webserver.WebServer"
