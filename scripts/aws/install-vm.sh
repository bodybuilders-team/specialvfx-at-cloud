...
run_cmd="source config.sh && java -cp $webserver_jar -javaagent:$instrumentation_jar_path=RequestAnalyzer:pt.ulisboa.tecnico.cnv.imageproc,pt.ulisboa.tecnico.cnv.raytracer:output pt.ulisboa.tecnico.cnv.webserver.WebServer"
